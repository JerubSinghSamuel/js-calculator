...
function changecolor(el, color, val) {
    if(el == 'total') {
        return
    }
    document.getElementById(el+'_bar').style.backgroundColor = color+"!important";
    document.getElementById(el+'_bar').style.width = val+"%";
    document.getElementById(el+'_bar2').style.backgroundColor = color+"!important";
    document.getElementById(el+'_bar2').style.width = val+"%";
