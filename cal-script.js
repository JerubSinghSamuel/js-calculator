...
function setVisibleImprove(text) {
    const ele = document.getElementById("improveText");
    switch (text) {
        case "repeat":
            imp_txt = "<b>Repeat Rate</b><br>"+imp_txt;
            if (rt_text == "Excellent") {
                ele.innerHTML = "Great job! Keep up the good work.";
                return 
            } else if (rt_text == "Poor")
            ...
            break;
        case "recency":
            imp_txt = "<b>Recency Index</b><br>"+imp_txt;
            if (ry_text == "Excellent") {
                ele.innerHTML = "Great job! Keep up the good work.";
                return 
            } else if (ry_text == "Poor")
            ...
            break;
        case "nps":
            imp_txt = "<b>NPS</b><br>"+imp_txt;
            if (ns_text == "Excellent") {
                ele.innerHTML = "Great job! Keep up the good work.";
                return 
            } else if (ns_text == "Poor")
                text = npsimp_txt[0]+npsimp_txt[1]+npsimp_txt[2]+npsimp_txt[3]+npsimp_txt[4];
            else
                text = npsimp_txt[0]+npsimp_txt[1]+npsimp_txt[2];
            break;
        case "trans":
            imp_txt = "<b>Loyalty Transaction</b><br>"+imp_txt;
            if (ts_text== "Excellent") {
                ele.innerHTML = "Great job! Keep up the good work.";
                return 
            } else if (ts_text == "Poor")
    ...
    ele.innerHTML = imp_txt+"<ul>"+text+"</ul>";
    imp_txt = "<b>Here are some steps to improve your score!</b>";
}
...
function setTotal() {
    ...
    switch (total_text) {
        case "Excellent":
            ...
            break;
        case "Poor":
            total.innerHTML = "<b>Things are not good at all when it comes to customer engagement. Immediate attention needs to be given to improve - "+setText+"!!</b>";
            break;
        default:
